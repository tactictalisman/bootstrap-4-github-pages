...
<div class="row">
  <div class="col-md-4">
    <a href="https://scryfall.com/card/c19/38/atla-palani-nest-tender">
     <img src="{{ site.baseurl }}/images/c19-38-atla-palani-nest-tender-web.jpg" class="img-responsive img-rounded" alt="Atla Palani, Nest Tender" style="max-width: 341px; width: 100%; height: auto;">
    </a>
  </div>
  <div class="col-md-4">
    <a href="https://scryfall.com/card/mor/145/thornbite-staff">
     <img src="{{ site.baseurl }}/images/magic/mor-145-thornbite-staff-web.jpg" class="img-responsive img-rounded" alt="Thornbite Staff" style="max-width: 341px; width: 100%; height: auto;">
    </a>
  </div>
  <div class="col-md-4">
    <a href="https://scryfall.com/card/xln/222/gishath-suns-avatar">
     <img src="{{ site.baseurl }}/images/xln-222-gishath-sun-s-avatar-web.jpg" class="img-responsive img-rounded" alt="Gishath, Sun's Avatar" style="max-width: 341px; width: 100%; height: auto;">
    </a>
  </div>
</div>
